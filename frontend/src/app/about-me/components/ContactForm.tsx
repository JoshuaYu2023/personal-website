        ...
        <section className={"md:p-6"}>
            ...
            <div className={"grid grid-cols-2 justify-items-center"}>
                ...
                <div className={"py-8 px-4 mx-auto max-w-screen-md"}>
                    <p className={'text-sm'}>Please reach out to me at <a className={'link text-green-800'} href={'mailto:joshayu17@outlook.com'}>joshayu17@outlook.com</a>. Thank you!</p>
                </div>
        </section>
    )
}
...
function Links({link, pic, alt}: LinkProps) {
    return (
        <Link href={link} target={"_blank"} rel={"noreferrer noopener"} className={'w-24 h-24 '}><img src={pic} alt={alt}
