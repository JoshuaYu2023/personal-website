        ...
        <section className="md:p-6">
            ...
            <div className="carousel w-full">
                ...
                <CarouselItem id={'item3'}
                              spotify={"https://open.spotify.com/embed/track/5w4DNXyuAZhUO4y3erBg9G?utm_source=generator&theme=0"}
...
function CarouselItem({id, spotify, text}: CarouselItemProps) {
    return (
        <div id={id} className={"carousel-item w-full flex-col items-center text-center rounded-lg"}>
