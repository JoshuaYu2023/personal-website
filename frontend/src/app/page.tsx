...
export default function Home() {
    return (
        <>
            ...
            <ProjectHero image={'/js-events.png'} alt={'Under Construction'} link={'/js-events'} title={'JavaScript Events'} description={'A web page that depicts different functions that can be created with JavaScript. UNDER CONSTRUCTION'}/>
